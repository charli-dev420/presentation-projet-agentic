...
This one-pager summarizes the agentic ecosystem: orchestration, MCP, Apps SDK, sub-agents, evidence, Unity/asset bridges, and human validation under public-safe boundaries.
